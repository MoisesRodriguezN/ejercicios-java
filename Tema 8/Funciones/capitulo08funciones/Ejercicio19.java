...
public class Ejercicio19 {
  ...
  public static long binarioAOctal(long binario) {
    ...
    octal = matematicas.Numeros.pegaPorDetras(octal, 1);
    octal = matematicas.Numeros.voltea(octal);
    octal = matematicas.Numeros.quitaPorDetras(octal, 1);
    octal = matematicas.Numeros.quitaPorDelante(octal, 1);
  ...
  public static long binarioADecimal(long binario) {
    ...
    int bits = matematicas.Numeros.digitos(binario);
    
    for(int i = 0; i < bits; i++) {
      decimal += matematicas.Numeros.digitoN(binario, bits - i - 1) * matematicas.Numeros.potencia(2, i);
    }
  ...
  public static long octalABinario(long octal) {
    ...
    for (int i = 0; i < matematicas.Numeros.digitos(octal); i++) {
      binario = binario * 1000 + decimalABinario(matematicas.Numeros.digitoN(octal, i));
    }
  ...
  public static long decimalABinario(long decimal) {
    ...
    while (decimal > 1) {
      binario = matematicas.Numeros.pegaPorDetras(binario, (int)decimal % 2);
      decimal = decimal / 2;
    }
    binario = matematicas.Numeros.pegaPorDetras(binario, 1);
    binario = matematicas.Numeros.voltea(binario);
    binario = matematicas.Numeros.quitaPorDetras(binario, 1);
