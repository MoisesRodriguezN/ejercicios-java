...
public class rey{
  public static void main(String[] args) {
    ...
    */
    ...
    //Se devuelve el rey a su posición de origen 
    ...
    //Tercer movimiento. Movimiento derecha
    if(columna !=8){
      columna +=1;
     switch (columna) {
        case 1:
    ...
    //Cuarto movimiento. Movimiento izquierda
    if(columna !=1){
      columna -=1;
     switch (columna) {
        case 1:
    ...
    //Quinto movimiento. Movimiento diagonal derecha arriba
    if(columna !=8 && fila !=8){
      columna +=1;
      fila +=1;
     switch (columna) {
    ...
    //Quinto movimiento. Movimiento diagonal izquierda arriba
    if(fila !=8 && columna !=1){
      columna -=1;
      fila +=1;
     switch (columna) {
    ...
    //Sexto movimiento. Movimiento diagonal izquierda abajo
    if(columna !=1 && fila !=1){
      columna -=1;
      fila -=1;
     switch (columna) {
    ...
    columna = auxconlumna;
    fila = auxfila;
       //Septimo movimiento. Movimiento diagonal derecha abajo
    if(columna !=8 && fila !=1){
      columna +=1;
      fila -=1;
     switch (columna) {
