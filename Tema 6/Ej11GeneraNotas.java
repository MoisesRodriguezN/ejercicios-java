...
public class Ej11GeneraNotas{
  public static void main(String[] args) {
    ...
    for(int i = 0; i < 20; i++) { //Genera las 20 notas
      
      nota = (int)(Math.random() * 5); //genera número del 0 al 5
      
      switch(nota) {
        case 0:
          System.out.print("suspenso ");
          suspensos++; //Suma el número de suspensos
          break;
        case 1:
